function(instance, context) {
        ...
        connection.ws.onmessage = function (evt) {
            ...
            if (msgStatus == 200) {
                ...
                if (sdpData !== undefined) {
                    if(instance.data.controller.type === "media_in" && !sdpData.sdp.match(/audio/m)) {
                        console.log('NO AUDIO! reconnect in 1s to', instance.data.recv_token);
                        setTimeout(function() {
                            init(instance.data.controller.fromId, instance.data.controller.type);
                        }, 1000);
                        return;
                    }
    ...
    function init(fromId, type) {
        ...
        instance.data.controller.type = type;
